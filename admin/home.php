...
<div class="row">
 ...
 <div class="col-12 col-sm-4 col-md-4">
  <div class="info-box">
    ...
    <div class="info-box-content">
      <span class="info-box-text">PrePaid Orders</span>
      <span class="info-box-number text-right h5">
        <?php 
          // Flexible query to match any prepaid variant
          $prepaid = $conn->query("SELECT id FROM order_list WHERE LOWER(payment_type) LIKE '%prepaid%'")->num_rows;
          echo format_num($prepaid);
        ?>
      </span>
    </div>
  </div>
