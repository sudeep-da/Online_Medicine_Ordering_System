...
$stat_arr = ['Pending Orders', 'Packed Orders', 'Our for Delivery', 'Completed Order', 'PrePaid']
?>
							...
							<td class="p-1 align-middle text-center">
								...
								switch($row['status']){
									...
									case 3:
										...
										break;
									case 4:
										echo '<span class="badge badge-teal bg-gradient-teal px-3 rounded-pill">Prepaid</span>';
										break;
								}
								?>
							</td>
